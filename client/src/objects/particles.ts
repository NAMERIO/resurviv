...
const ParticleDefs: Record<string, ParticleDef> = {
    ...
    pyrePlank: {
        ...
        color: function () {
            return util.rgbToInt(util.hsvToRgb(util.random(0, 0.125), 1, util.random(0.6, 0.8)));
        },
    },
    woodShard: {
        image: ["part-spark-02.img"],
    ...
    poison_gas: {
        image: ["part-foam-01.img", "part-foam-02.img", "part-foam-03.img", "part-foam-04.img", "part-foam-05.img"],
