...
export const IdlePoses: Record<string, Partial<Record<Bones, Pose>>> = {
    ...
    meleeLasrSwrd: {
        [Bones.HandL]: new Pose(v2.create(12, 12.5)),
        [Bones.HandR]: new Pose(v2.create(7, 22)),
    },
};
...
> = {
    ...
    lasrSwrdSwing: {
        keyframes: [
            ...
            frame(def.lasr_swrd_01.attack.damageTimes[0] * 0.4, {
                [Bones.HandL]: new Pose(v2.create(12, 12.5)).rotate(Math.PI * 0.2),
                [Bones.HandR]: new Pose(v2.create(7, 22)).rotate(Math.PI * 0.2),
            }),
            frame(def.lasr_swrd_01.attack.damageTimes[0] * 0.7, {
                [Bones.HandL]: new Pose(v2.create(12, 12.5)).rotate(-Math.PI * 1.1),
                [Bones.HandR]: new Pose(v2.create(7, 22)).rotate(-Math.PI * 1.1),
            }),
            frame(def.lasr_swrd_01.attack.cooldownTime, {
                [Bones.HandL]: new Pose(v2.create(12, 12.5)),
                [Bones.HandR]: new Pose(v2.create(7, 22)),
            }),
        ],
    ...
    lasrSwrd_pose_1: {
        keyframes: [
            ...
            frame(def.lasr_swrd_01.attack.damageTimes[0] * 0.5, {
                [Bones.HandL]: new Pose(v2.create(10.5, 0.0)).rotate(-Math.PI * 0.2),
                [Bones.HandR]: new Pose(v2.create(18.0, 0.5)).rotate(-Math.PI * 0.2),
            }),
            frame(def.lasr_swrd_01.attack.damageTimes[0], {
                [Bones.HandL]: new Pose(v2.create(10.5, 0.0)),
                [Bones.HandR]: new Pose(v2.create(18.0, 0.5)),
            }),
        ],
        effects: [
            effect(def.lasr_swrd_01.attack.damageTimes[0], "animPlaySound", {
                sound: "lasr_swing_01",
            }),
            effect(def.lasr_swrd_01.attack.damageTimes[0], "animMeleeCollision", {}),
        ],
    },
    lasrSwrd_pose_2: {
        keyframes: [
