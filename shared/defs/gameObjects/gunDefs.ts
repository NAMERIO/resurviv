...
export const BaseDefs: Record<string, GunDef> = {
    ...
    flux_rifle: {
        ...
        shotSpread: 2,
        bulletCount: 1,
        bulletType: "bullet_flux_rifle",
        headshotMult: 2,
        speed: { equip: 0, attack: 0 },
        lootImg: {
            sprite: "loot-weapon-flux-rifle.img",
            tint: 0xff00,
            border: "loot-circle-outer-01.img",
            borderTint: 0,
            scale: 0.3,
    ...
    prop_o_matic: {
        ...
        speed: { equip: 0, attack: 0 },
        lootImg: {
            sprite: "loot-weapon-prop-o-matic.img",
            tint: 0xff00,
            border: "loot-circle-outer-01.img",
            borderTint: 0,
            scale: 0.3,
    ...
    snow_cannon: {
        ...
        bulletCount: 1,
        bulletType: "bullet_invis",
        projType: "snow_cannonball",
        noSplinter: true,
        headshotMult: 1,
        speed: { equip: -3, attack: 0 },
        lootImg: {
            sprite: "loot-weapon-snow-cannon.img",
            tint: 0xff00,
            border: "loot-circle-outer-01.img",
            borderTint: 0,
            scale: 0.3,
    ...
    bazooka: {
        ...
        worldImg: {
            ...
            recoil: 10,
            handsBelow: true,
            onLoadComplete: "gun-bazooka-loaded.img",
        },
        particle: {
            shellScale: 0,
            shellOffset: 0,
