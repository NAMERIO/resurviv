...
function createDesertTown2<T extends BuildingDef>(e: Partial<T>): T {
    const t = {
        type: "building",
        map: { display: true, shapes: [] },
        terrain: { grass: true, beach: false },
...
function createReactor<T extends ExtendedBuildingDef>(e: Partial<T>): T {
    const t = {
        ...
        terrain: { grass: true, beach: false },
        mapObstacleBounds: [
            collider.createAabbExtents(v2.create(7.5, 0), v2.create(4.5, 8)),
            collider.createAabbExtents(v2.create(-0.9, 0), v2.create(5.5, 18.5)),
            collider.createAabbExtents(v2.create(-22, 0), v2.create(5.5, 18.5)),
            collider.createAabbExtents(v2.create(-11.5, 0), v2.create(10, 21)),
            collider.createAabbExtents(v2.create(-11.5, 0), v2.create(20, 11)),
            collider.createAabbExtents(v2.create(19, 14), v2.create(12, 11)),
            collider.createAabbExtents(v2.create(19, -14), v2.create(12, 11)),
            collider.createAabbExtents(v2.create(14.5, 0), v2.create(5.5, 8)),
        ],
        zIdx: 1,
        floor: {
            surfaces: [
...
export const MapObjectDefs: Record<string, MapObjectDef> = {
    ...
    bush_07p: createBush({
        hitParticle: "leafRiver",
        explodeParticle: "leafRiver",
        map: { display: true, color: 1526631, scale: 1.5 },
        img: {
            sprite: "map-bush-07-perk.img",
            residue: "map-bush-res-perk.img",
            alpha: 1,
            scale: 0.5,
        },
        sound: { enter: "bush_enter_02" },
    ...
    bush_01p: createBush({
        hitParticle: "leafRiver",
        explodeParticle: "leafRiver",
        map: { display: true, color: 2791335, scale: 1.5 },
        img: {
            sprite: "map-bush-01-perk.img",
            residue: "map-bush-res-perk.img",
            alpha: 1,
            scale: 0.5,
        },
    ...
    crate_01p: createCrate({
        loot: [tierLoot("tier_guns", 3, 3)],
        img: { sprite: "map-crate-01-perk.img" },
    }),
    ...
    crate_02p: createCrate({
        ...
        map: { display: true, color: 1526631 },
        terrain: { grass: true, beach: false },
        img: { sprite: "map-crate-02-perk.img" },
        sound: { explode: "crate_break_01" },
    } as unknown as Partial<ObstacleDef>),
    ...
    crate_frenemies_metal: createCrate({
        ...
        hitParticle: "woodChip",
        explodeParticle: "woodPlank",
        collision: collider.createAabbExtents(v2.create(0, 0), v2.create(3.3, 1.4)),
        loot: [tierLoot("tier_world", 3, 5), tierLoot("tier_guns", 1, 1)],
        map: { display: false },
        terrain: { grass: true, beach: false },
        img: {
    ...
    airdrop_crate_01p: createAirdrop({
        button: {
            useImg: "map-airdrop-02-perk.img",
            useParticle: "airdropCrate01",
            sound: { on: "airdrop_open_01", off: "" },
        },
        img: {
            sprite: "map-airdrop-01-perk.img",
            residue: "none",
        },
        destroyType: "crate_10p",
        explodeParticle: "airdropCrate02",
    } as unknown as Partial<ObstacleDef>),
    airdrop_crate_02p: createAirdrop({
        button: {
            useImg: "map-airdrop-02-perk.img",
            useParticle: "airdropCrate01",
            sound: { on: "airdrop_open_01", off: "" },
    ...
    tree_01p: createTree({
        map: { display: true, color: 1526631, scale: 2.5 },
        img: {
            sprite: "map-tree-01-perk.img",
        },
    }),
    tree_02: createTree({
        health: 120,
    ...
    tree_13: createTree({
        ...
        isTree: true,
        loot: [],
        map: { display: true, color: 0xffe4e1, scale: 2.5 },
        img: {
    ...
    vat_brain: {
        ...
        hitParticle: "glassChip",
        explodeParticle: "windowBreak",
        loot: [autoLoot("outfitBraaains", 1)],
        map: { display: true, color: 0xb3b3b3, scale: 1 },
        terrain: { grass: false, beach: false },
        img: {
    ...
    vat_cosmic_blue: {
        ...
        hitParticle: "glassChip",
        explodeParticle: "windowBreak",
        loot: [autoLoot("outfitCosmicBlue", 1)],
        map: { display: true, color: 0xb3b3b3, scale: 1 },
        terrain: { grass: false, beach: false },
        img: {
    ...
    desert_town_02: createDesertTown2({}),
    desert_town_02p: createDesertTown2({
        mapGroundPatches: [
            {
                bound: collider.createAabbExtents(v2.create(0, -3), v2.create(45, 55)),
                color: 4213882,
    ...
    desert_town_02v: createDesertTown2({
        mapGroundPatches: [
            {
                bound: collider.createAabbExtents(v2.create(0, -3), v2.create(45, 55)),
                color: 0x6b9940,
    ...
    */
    ...
    teahouse_complex_01p: createTeaHouseComplex({
        grass_color: 3818586,
        tree_small: "tree_01p",
        tree_large: "tree_01p",
    }),
