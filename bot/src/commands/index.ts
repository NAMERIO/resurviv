...
const commands = {
    ...
    [Command.ResetFeaturedBundlesTimer]: createCommand({
        name: Command.ResetFeaturedBundlesTimer,
        description: "Restart the featured bundle countdown from now",
        optionValidator: zResetFeaturedBundlesTimerBody,
        isPrivateRoute: true,
        ownerOnly: true,
        options: [],
    }),
